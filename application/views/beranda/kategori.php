                        ...
                        <div class="col-lg-offset-5 col-md-offset-3 col-lg-7 col-md-9 ">
                            <div class="card" style="background-color:rgba(255,255,255,0);">
                                <div class="card-body" style="background-color:rgba(255,255,255,0);padding-top:5px;">
                                    <h4 class="card-title" style="color:rgb(159,35,35);"><?php echo $p->judul; ?></a></h4>
                                    <h6 class="text-muted card-subtitle mb-2 tanggalUpload"><?php echo tgl($p->tgl_konfirm2); ?> <i>(<?php 
                                    foreach($kategori as $v)
                                    if($v->id_kategori==$p->id_kategori){
                                        echo $v->kategori_artikel;
                                    } else {} ?>)</i></h6>
...
<div class="row">
                        <div class="col-lg-12 mt-2">
    <a class="btn btn-primary" role="button" href="<?php echo site_url('artikel/index/'); ?>">Lihat Semua Artikel</a><br>
</div> </div>
                </div>
            </div>
        </div>
